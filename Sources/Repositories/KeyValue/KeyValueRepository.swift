...
public struct KeyValueRepository<CodableEntity: Codable & Equatable & Sendable>: AsyncInsertableRepository, SyncInsertableRepository, DeleteableRepository, UpdatableRepository, ReadableRepository {
